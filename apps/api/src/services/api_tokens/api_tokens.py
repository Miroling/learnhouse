...
def _resolve_atlas_rights(db_session: Session, user_id: int, org_id: int) -> dict:
    ...
    role = get_user_org_role(user_id, org_id, db_session)
...
def create_atlas_session_token(
    db_session: Session,
    user_id: int,
    org_id: int,
    ...
    rights = _resolve_atlas_rights(db_session, user_id, org_id)
...
def revoke_atlas_session_token(
    db_session: Session,
    token_uuid: str,
    user_id: int,
) -> bool:
